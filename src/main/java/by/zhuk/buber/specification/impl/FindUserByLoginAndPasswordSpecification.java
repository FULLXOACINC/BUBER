...
public class FindUserByLoginAndPasswordSpecification implements SQLSpecification {
    ...
    private static final String SELECT_BY_LOGIN_AND_PASSWORD = "SELECT user_login,user_name, user_second_name, user_password, user_type, user_balance, user_birth_dey, user_phone_number, user_is_ban FROM buber_db.user WHERE user_login=? AND user_password=SHA1(?)";
