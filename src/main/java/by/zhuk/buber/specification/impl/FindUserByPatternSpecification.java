...
public class FindUserByPatternSpecification implements SQLSpecification {
    ...
    private static final String SELECT_BY_PATTERN= "SELECT user_login,user_name, user_second_name, user_password, user_type, user_balance, user_age, user_phone_number, user_is_ban FROM buber_db.user WHERE user_login LIKE ? OR user_name LIKE ? OR user_second_name LIKE ? OR user_phone_number LIKE ?";
